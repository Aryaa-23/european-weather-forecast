                ...
                {weatherData.map((day: WeatherData, index: number) => (
                  <Card key={index} className="bg-white rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
                    <CardContent className="p-6 text-center">
                      <div className="text-sm font-semibold text-gray-500 mb-2">{day.dayName}</div>
                      <div className="text-xs text-gray-400 mb-4">{day.date}</div>
                      ...
                      <div className="mb-3">
                        <div className="text-2xl font-bold text-dark-gray">{day.temperature}°{temperatureUnit === 'celsius' ? 'C' : 'F'}</div>
                        <div className="text-sm text-gray-500">{day.tempRange}</div>
                      </div>
                      
                      <div className="text-sm font-medium text-gray-600 mb-2">{day.condition}</div>
